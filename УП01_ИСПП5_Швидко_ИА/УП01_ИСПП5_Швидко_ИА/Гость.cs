...
namespace УП01_ИСПП5_Швидко_ИА
{
    public partial class Гость : Form
    {
        ...
        private void Гость_Load(object sender, EventArgs e)        //Загрузка данных в таблицы
        {
        ...
        Point Mouse;
        private void Гость_MouseMove(object sender, MouseEventArgs e)        //Перемещает форму при удержании мыши
        {
        ...
        private void Гость_MouseDown(object sender, MouseEventArgs e)        //Перемещает форму при удержании мыши
        {
            Mouse = new Point(e.X, e.Y);
        }
        string pic;

        private void Поле_для_таблиц_DataGridView1_CellClick_1(object sender, DataGridViewCellEventArgs e)       //Изменение фотографий при нажатие на разные строки
        {
            try
            {
