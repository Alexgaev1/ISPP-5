...
namespace УП01_ИСПП5_Швидко_ИА
{
    public partial class Продавец : Form
    {
        ...
        public void Tub(int i)             //Добавляет таблицы
        {
        ...
        private void Продавец_Load(object sender, EventArgs e)        //Загрузка данных в таблицы
        {
        ...
        Point Mouse;
        private void Продавец_MouseMove(object sender, MouseEventArgs e)        //Перемещает форму при удержании мыши
        {
        ...
        private void Продавец_MouseDown(object sender, MouseEventArgs e)        //Перемещает форму при удержании мыши
        {
