...
namespace Отдел_кадров_университета
{
    public partial class Administrator : Form
    {
        ...
        private void button24_Click(object sender, EventArgs e)
        {
            flowLayoutPanel1.Width = widthFlowLayoutPanel;
            flowLayoutPanel1.Height = heightFlowLayoutPanel;
            x = button24.Location.X + button24.Size.Width;
            y = button24.Location.Y;
            flowLayoutPanel1.Controls.Clear();
            flowLayoutPanel1.Location = new Point(x, y);
            flowLayoutPanel1.Width = 200;
            flowLayoutPanel1.BackColor = Color.FromArgb(192, 192, 255);
            ...
            Button buttonПользователи = new Button();
            buttonПользователи.Text = "Пользователи";
            buttonПользователи.Width = flowLayoutPanel1.Width - 5;
            buttonПользователи.Click += buttonПользователи_Click;
            flowLayoutPanel1.Controls.Add(buttonПользователи);

            Button buttonДобавитьПользователя = new Button();
            buttonДобавитьПользователя.Text = "Добавить пользователя";
            buttonДобавитьПользователя.Width = flowLayoutPanel1.Width - 5;
            buttonДобавитьПользователя.Click += buttonДобавитьПользователя_Click;
            flowLayoutPanel1.Controls.Add(buttonДобавитьПользователя);
        }

        private void buttonДобавитьПользователя_Click(object sender, EventArgs e)
        {
            button10.Enabled = true;
            button27.Enabled = true;
            button17.Enabled = true;
        ...
        private void buttonПользователи_Click(object sender, EventArgs e)
        {
            button10.Enabled = true;
            button27.Enabled = true;
            button17.Enabled = true;
            ...
            indexOfPanel = 7;
            indexOfDataGridView = 7;
            nameOfTable = "Пользователи";

            OpenPanels.openPanels(tableLayoutPanel1, indexOfPanel);

            dataGridView3.DataSource = пользователиbindingSource;

            dataGridView3.Columns["ПраваДоступа"].HeaderText = "Права доступа";
            dataGridView3.Columns["КодПользователя"].HeaderText = "Код пользователя";
