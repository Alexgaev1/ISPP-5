...
namespace Проект
{
    public partial class Battalion : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            searchInDataGridView(textBox1.Text);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            sqlConnect.Open();
            SqlDataAdapter da = new SqlDataAdapter($"INSERT   INTO Батальон(Название,Код_командира,[Код_ Зам_Командира]) VALUES('{textBox3.Text}','{textBox2.Text}','{textBox1.Text}');", sqlConnect); ;
