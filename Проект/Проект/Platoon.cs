...
namespace Проект
{
    public partial class Platoon : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            sqlConnect.Open();
            SqlDataAdapter da = new SqlDataAdapter($"INSERT   INTO Взвод(Код_роты,Код_командира,Название,Код_Зам_командира) VALUES('{textBox1.Text}','{textBox2.Text}','{textBox4.Text}','{textBox3.Text}');", sqlConnect); ;
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            SqlConnection sqlConnect = new SqlConnection("Data Source=sql;Initial Catalog = уП_ПМ01_ИСПП_5_Степурин_НС; Integrated Security = True");
            sqlConnect.Open();
            SqlDataAdapter da = new SqlDataAdapter($"DELETE FROM  Взвод WHERE Код_взвода = {label2.Text}; ", sqlConnect);
            DataTable dt = new DataTable();
            da.Fill(dt);
            взводTableAdapter.Fill(уП_ПМ01_ИСПП_5_Степурин_НСDataSet.Взвод);
        }
